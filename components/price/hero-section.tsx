...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#020F59] via-[#021373] to-[#1F54BF] py-20 md:py-28">
      <div className="absolute inset-0 opacity-30">
        <img src="/backgrounds/chipset-tech-background.svg" alt="" className="h-full w-full object-cover" />
      </div>
