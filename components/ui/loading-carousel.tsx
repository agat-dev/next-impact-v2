...
const defaultTips: Tip[] = [
  {
    text: "Les infos nécessaires pour mener à bien votre projet.",
    image: "/placeholders/cult-snips.png",
    url: "https://www.newcult.co/backend",
  },
  {
    text: "Les outils pour faire les bons choix",
    image: "/placeholders/cult-dir.png",
    url: "https://www.newcult.co/templates/cult-seo",
  },
  {
    text: "Les methodes pour vous faire gagner du temps.",
  ...
  {
    text: "L'optimisation dans la durée.",
