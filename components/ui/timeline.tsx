...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full rounded-3xl bg-white dark:bg-neutral-950 font-sans "
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto pt-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg font-medium md:text-3xl mb-4 text-regularblue dark:text-white max-w-4xl">
          Créer son site web : Etape par étape
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-xl mb-4">
          Créer son site web est un processus qui nécessite de la planification,
