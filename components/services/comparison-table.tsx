...
export function ComparisonTable() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-20">
      <h2 className="text-3xl font-bold text-white text-center mb-10">Comparatif des Packs</h2>

      <Card className="overflow-hidden bg-white/5 backdrop-blur-sm border-[#719ED9]/30">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#719ED9]/30">
                <th className="text-left p-6 text-white font-semibold">Fonctionnalité</th>
            ...
            <tbody>
              {comparison.map((row, idx) => (
                <tr key={idx} className="border-b border-[#719ED9]/20 hover:bg-white/5 transition-colors">
                  <td className="p-6 text-[#D0DCF2]">{row.feature}</td>
                  <td className="p-6 text-center">
                    {typeof row.pack1 === "boolean" ? (
                      ...
                      <span className="text-[#D0DCF2]">{row.pack1}</span>
                    )}
                  </td>
                  <td className="p-6 text-center">
                    {typeof row.pack2 === "boolean" ? (
                      ...
                      <span className="text-[#D0DCF2] font-semibold">{row.pack2}</span>
                    )}
                  </td>
                  <td className="p-6 text-center">
                    {typeof row.pack3 === "boolean" ? (
                      ...
                      <span className="text-[#D0DCF2] font-semibold">{row.pack3}</span>
                    )}
                  </td>
                </tr>
              ))}
